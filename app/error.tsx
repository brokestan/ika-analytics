  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="card p-8 max-w-md w-full text-center space-y-4">
        ...
        <p className="text-sm text-ika-dim">The dashboard failed to load. This is usually temporary.</p>
        {error.digest && (
          <p className="font-mono text-xs text-ika-muted bg-white/5 px-3 py-1.5 rounded-lg">
            Error ID: {error.digest}
          </p>
        )}
        <button onClick={reset} className="inline-flex items-center gap-2 btn-ika mx-auto">
