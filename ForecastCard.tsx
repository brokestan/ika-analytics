...
export default function ForecastCard({ current, day30, day60, seasonEnd, loading }: Props) {
  ...
  const milestones = [
    { label: '30 Day Forecast', value: day30, color: 'text-cyan-400' },
    { label: '60 Day Forecast', value: day60, color: 'text-violet-400' },
    { label: 'Season End',      value: seasonEnd, color: 'text-ika-pink' },
  ];
    ...
    <div className="card p-5 animate-slide-up" style={{ animationDelay: '250ms' }}>
      ...
      <ResponsiveContainer width="100%" height={140}>
        <AreaChart data={chartData} margin={{ top: 5, right: 5, bottom: 0, left: 0 }}>
          ...
          <XAxis
            dataKey="label"
            tick={{ fill: '#6B5A8E', fontSize: 10, fontFamily: 'JetBrains Mono' }}
            axisLine={false}
            tickLine={false}
          />
          <YAxis hide />
